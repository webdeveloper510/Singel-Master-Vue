...
export default {
  ...
  lineChart: {
    ...
    data: {
      ...
      datasets: [
        {
          data: [],
          label: 'Normal Message sent',
          borderColor: chartColors.yellowColor,
          lineTension: 0.5,
          pointStyle: 'circle',
          ...
          pointHoverBackgroundColor: chartColors.yellowColor,
  ...
  revenueChart: {
    ...
    data: {
      labels: ['2020-01-01', '2020-01-02', '2020-01-03', '2020-01-04', '2020-01-05', '2020-01-06', '2020-01-07', '2020-01-08',
        '2020-01-09', '2020-01-10', '2020-01-11', '2020-01-12', '2020-01-13', '2020-01-14', '2020-01-15'],
      datasets: [
        {
          data: [23.55, 150.33, 18.44, 27.55, 21.99, 16.77, 16.66, 0, 0, 0, 0, 25.5, 29.0, 36.0, 37.5],
          label: 'revenue',
          ...
          pointHoverRadius: 8,
          pointHoverBorderWidth: 5,
          pointBorderColor: chartColors.lineChartDanger,
          pointHoverBorderColor: $themeColors.white,
