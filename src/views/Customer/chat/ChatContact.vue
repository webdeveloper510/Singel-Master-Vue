  ...
  >
    ...
    <div class="chat-info flex-grow-1">
      ...
      <p class="card-text text-truncate">
        {{ isChatContact ? user.lastMessage : user.about }}
      </p>
    </div>
    <div
      v-if="isChatContact"
    ...
    >
      <!--      <small class="float-right mb-25 chat-time">{{ formatDateToMonthShort(user.lastMessage.time, { hour: 'numeric', minute: 'numeric' }) }}</small>-->
      <b-badge
