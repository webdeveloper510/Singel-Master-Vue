export default [
  ...
  },
  {
    ...
    name: 'activate',
    component: () => import('@/views/pages/authentication/Active.vue'),
    meta: {
      layout: 'full',
      resource: 'Auth',
      redirectIfLoggedIn: true,
  ...
  },
  {
    ...
    component: () => import('@/views/pages/Single/TermsConditions.vue'),
    meta: {
      resource: 'Auth',
    },
  },
  {
    path: '/policy-cookie',
    name: 'policy-cookie',
    component: () => import('@/views/pages/Single/PolicyandCookie.vue'),
    meta: {
      resource: 'Auth',
    },
  },
