...
const data = {
  profileData: {
    ...
    userAbout: {
      ...
      county: 'kahigeki',
      city: 'storingk',
      personality: 'Ej angivet',
      relationship_status: 'Ej angivet',
      ethinicity: 'Ej angivet',
      Religion: 'Ej angivet',
      hair_color: 'Ej angivet',
      Appearance: 'Ej angivet',
      eye_color: 'Ej angivet',
      body_type: 'Ej angivet',
      star_sign: 'Ej angivet',
      smoking_habbit: 'Ej angivet',
      drinking_habbit: 'Ej angivet',
      best_feature: 'Ej angivet',
      body_art: 'Ej angivet',
      sexual_orientation: 'Ej angivet',
      height: 'Ej angivet',
      weight: 'Ej angivet',
      kids: 'Ej angivet',
      interests: 'Ej angivet',
      about: 'Ej angivet',
    },
    suggestedPages: [
      {
    ...
    latestPhotos: [
      ...
      { img: require('@/assets/images/profile/user-uploads/timeline.jpg') },
    ],
    suggestions: [
      {
